...
class ad_generator_shortcode {
	...
	static function ad_generator_func( $atts ) {
		...
		$result_text .= '<br /><input type="radio" name="ad_count" value="10" id="ads_10" checked>10<br />';
		$result_text .= '<input type="radio" name="ad_count" value="100" id="ads_100">100<br />';
		$result_text .= '<input type="radio" name="ad_count" value="300" id="ads_300">300<br /></p>';
